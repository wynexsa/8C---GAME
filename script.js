...
// Web Audio API Sound Synthesizer for instant, reliable sound effects
...
function selectOption(selectedIndex, btnElement) {
    ...
    if (selectedIndex === q.answer) {
        // Doğru bildiğinde can gitmez, puan artar, doğru ses efekti çalar
        btnElement.classList.add('correct');
        score += 20;
        playCorrectSound();
    } else {
        // Yanlış bildiğinde can azalır, yanlış ses efekti çalar, doğru cevap gösterilir
